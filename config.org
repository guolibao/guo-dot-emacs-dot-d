...
**** plantuml to tikz in latex
***** example plantuml source code in org
using the =:cmdline -tlatex= to convert to latex file
#+BEGIN_SRC plantuml :file plantuml-to-tikz-in-latex.tex :cmdline -tlatex
a->b:guo
#+END_SRC

***** latex output from the plant uml
#+BEGIN_SRC latex
  \documentclass{article}
  \usepackage{tikz}
  \usepackage{aeguill}
  \begin{document}
  % generated by Plantuml 1.2018.01      
  ...
  \begin{tikzpicture}[yscale=-1
    ...
    \draw[pstyle0] (21pt,38.2969pt) -- (21pt,87.4297pt);
    \draw[pstyle0] (73.1444pt,38.2969pt) -- (73.1444pt,87.4297pt);
    \draw[pstyle1] (8pt,3pt) rectangle (31.6pt,33.2969pt);
    \node at (15pt,10pt)[below right,color=black]{a};
    \draw[pstyle1] (8pt,86.4297pt) rectangle (31.6pt,116.7266pt);
    \node at (15pt,93.4297pt)[below right,color=black]{a};
    \draw[pstyle1] (60.1444pt,3pt) rectangle (84.0556pt,33.2969pt);
    \node at (67.1444pt,10pt)[below right,color=black]{b};
    \draw[pstyle1] (60.1444pt,86.4297pt) rectangle (84.0556pt,116.7266pt);
    \node at (67.1444pt,93.4297pt)[below right,color=black]{b};
    \draw[color=plantucolor0000,fill=plantucolor0000,line width=1.0pt] (62.1pt,65.2969pt) -- (72.1pt,69.2969pt) -- (62.1pt,73.2969pt) -- (66.1pt,69.2969pt) -- cycle;
    \draw[color=plantucolor0000,line width=1.0pt] (21.8pt,69.2969pt) -- (68.1pt,69.2969pt);
    \node at (28.8pt,52.2969pt)[below right,color=black]{guo};
  \end{tikzpicture}
  \end{document}
#+END_SRC
...
*** orgmode src example quote verse center, etc,block
s    #+begin_src ... #+end_src 
...
#+begin_src latex :file fsa.pdf :packages '(("" "tikz")) :border 1em :results raw
  ...
  \begin{tikzpicture}[thick,help lines/.style={thin,draw=black!50}]
    ...
    \def\B{\textcolor{input}{$B$}}\def\C{\textcolor{output}{$C$}}
    \def\D{$D$}\def\E{$E$}\colorlet{input}{blue!80!black}
    ...
    \path [name intersections={of=D and E,by={[label=above:\C]C}}];\draw [output] (A) -- (C) -- (B);
    \foreach \point in {A,B,C}\fill [black,opacity=.5] (\point) circle (2pt);
    \begin{pgfonlayer}{background}\fill[triangle!80] (A) -- (C) -- (B) -- cycle;\end{pgfonlayer}
